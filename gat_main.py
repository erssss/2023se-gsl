...
from utils.encode_tree import PartitionTree
...
if __name__ == "__main__":
    ...
    if args.dataset == "citeseer" or args.dataset == "cora":
        ...
        or args.dataset == "texas"
        or args.dataset == "wisconsin"
    ):
        args.n_hidden = 32
        args.learning_rate = 1e-2
